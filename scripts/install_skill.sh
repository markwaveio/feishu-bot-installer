...
cp "$SKILL_ROOT/scripts/create_hermes_feishu_bot_installer.sh" "$DEST/scripts/create_hermes_feishu_bot_installer.sh"
...
chmod +x "$DEST/scripts/create_feishu_bot.sh" "$DEST/scripts/create_additional_feishu_bot.sh" "$DEST/scripts/create_hermes_feishu_bot_installer.sh" "$DEST/scripts/bind_feishu_agent.sh" "$DEST/scripts/configure_feishu_account.sh" "$DEST/scripts/verify_feishu_mapping.sh"
